...
/// This presentation supports the <code>currentColor</code> inheritance.
...
/// Rasterized UIImage object that supports template rendering and proportionally fits the proposed size.
@property (nonatomic, strong) UIImage * _Nullable aspectFitRasterizedImage;
